          ...
          <div className="flex flex-wrap">

            {
              sizes.map(size => (
                ...
                <div onClick={() => onSizeChanged(size)} key={size} className={
                  clsx(
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
            {
              product.ProductImage?.map(image => (
                <div className="" key={image.id}>
                  <ProductImage src={image.url} alt={product.title!}
                    width={300}
                    height={300}
                  ...
                  <button
                    ...
                    type="button" className="btn-danger rounded-b-md w-full">Eliminar</button>
                </div>
